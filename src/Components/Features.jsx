                            ...
                            <div className="row align-self-center gy-5">
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Recognized for excellence in performance, design, and customer satisfaction across industries.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Automate repetitive processes and improve productivity with our smart workflow tools.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Customize every aspect of your experience with powerful tools designed for creators and teams.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Find exactly what you need with intelligent filters and adaptive search capabilities.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Experience blazing-fast load times and efficient resource handling on every device.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 icon-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Dependable, tested, and trusted by thousands of users for mission-critical operations.</p>
                                    </div>
                                </div>
